...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <p>This is a friendly reminder that payment for your order is still pending.</p>
            ...
            <p>Please <a href="{{ route('payments.show', $applicationCode) }}">make payment</a> at your earliest convenience. Please ignore if you have already made payment. Thank you!</p>
        </div>
